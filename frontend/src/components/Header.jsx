...
const Header = () => {
  ...
  return (
    <header className="bg-white w-dvw">
      <div className="mx-auto flex h-16 w-dvw max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
        <Link
          to="/"
        >
        ...
        <div className="flex flex-1 items-center justify-end md:justify-between">
          <nav aria-label="Global" className="hidden md:block">
            <ul className="flex items-center gap-6 text-sm">
              ...
              <li>
                <Link to="/vehicles" className="text-gray-500 transition hover:text-gray-500/75">Vehicles</Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-500 transition hover:text-gray-500/75">Contact Us</Link>
              </li>
            </ul>
          </nav>
